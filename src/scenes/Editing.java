...
public class Editing extends GameScene implements SceneMethods {
	...
	public Editing(Game game) {
		...
		levelEditor = new LevelEditor(lvl, start, end);
	}
	...
	public void saveLevel() {
		levelEditor.setLevelData(lvl);  // Lưu dữ liệu bản đồ vào LevelEditor
	    levelEditor.setStartPoint(start);
	    levelEditor.setEndPoint(end);
